...
namespace FORWARD
{
	// lite render for baking (unchanged)
	void lite_render(
	...
	// Main rasterization — now also writes snapshots into SampleState buffers
	// and records max_contrib per tile.
	void render(
		const dim3 grid, dim3 block,
		const int W, int H,
